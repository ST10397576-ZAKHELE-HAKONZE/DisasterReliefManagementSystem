...
namespace GiftOfTheGivers.Web.Controllers
{
    public class DonorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DonorID,FirstName,LastName,ContactNumber,Email")] Donor donor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DonorID,FirstName,LastName,ContactNumber,Email")] Donor donor)
        {
            if (id != donor.DonorID)
            {
                return NotFound();
